...
public class Constant {
    //设置两个之前获取的两个常量
    //测试版的key
    public static final String Key="ZmvnKP2zG8HvdBCVA3bK2mLy5BLGLVEB";//我的key
    public static final String Secret="NTjGLp2Xlh16W4pDeVKwmr8LglVB4mYQ";//我的Secret

    public static String facesetToken="";

    //服务器地址
    public static String htUrl="http://35.189.153.53:5001";
